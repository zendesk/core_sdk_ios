...
typedef SWIFT_ENUM_NAMED(NSInteger, ZDKIdentityType, "IdentityType", open) {
  ZDKIdentityTypeAnonymous = 0,
  ZDKIdentityTypeJwt = 1,
};
...
@property (nonatomic, readonly) enum ZDKIdentityType type;
@end
...
@property (nonatomic, readonly) enum ZDKIdentityType identityType;
