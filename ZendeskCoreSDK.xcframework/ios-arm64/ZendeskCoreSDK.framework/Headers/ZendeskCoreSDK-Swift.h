...
enum ZDKClassicLogLevel : NSInteger;
@class NSString;

SWIFT_CLASS_NAMED("CoreLogger")
@interface ZDKClassicCoreLogger : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) enum ZDKClassicLogLevel logLevel;)
+ (enum ZDKClassicLogLevel)logLevel SWIFT_WARN_UNUSED_RESULT;
+ (void)setLogLevel:(enum ZDKClassicLogLevel)value;
...
@interface ZDKClassicHelpCenterUtil : NSObject
...
typedef SWIFT_ENUM_NAMED(NSInteger, ZDKClassicIdentityType, "IdentityType", open) {
  ZDKClassicIdentityTypeAnonymous = 0,
  ZDKClassicIdentityTypeJwt = 1,
};

typedef SWIFT_ENUM_NAMED(NSInteger, ZDKClassicLogLevel, "LogLevel", open) {
  ZDKClassicLogLevelError = 0,
  ZDKClassicLogLevelWarn = 1,
  ZDKClassicLogLevelInfo = 2,
  ZDKClassicLogLevelDebug = 3,
  ZDKClassicLogLevelVerbose = 4,
};
...
@interface ZDKClassicUser : NSObject
/// The user’s id
...
@class NSDate;
@class ZDKClassicUserFieldOption;

/// User Field in Zendesk
SWIFT_CLASS_NAMED("UserField")
@interface ZDKClassicUserField : NSObject
/// User Field id
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
/// Url of user field
...
@property (nonatomic, readonly, copy) NSArray<ZDKClassicUserFieldOption *> * _Nullable custom_field_options;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface ZDKClassicUserFieldOption : NSObject
/// id of option
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
/// name of option
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
...
@property (nonatomic, readonly) enum ZDKClassicIdentityType type;
@end
...
SWIFT_CLASS_NAMED("ZDKPushProvider")
@interface ZDKClassicPushProvider : NSObject
/// Initialize the provider
/// \param zendesk An instance of the zendesk singleton
///
- (nonnull instancetype)initWithZendesk:(ZDKClassicZendesk * _Nonnull)zendesk OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS_NAMED("ZDKUserProvider")
@interface ZDKClassicUserProvider : NSObject
/// Initialize the provider
/// \param zendesk An instance of the zendesk singleton
///
- (nonnull instancetype)initWithZendesk:(ZDKClassicZendesk * _Nonnull)zendesk OBJC_DESIGNATED_INITIALIZER;
...
///
- (void)getUserWithCompletion:(void (^ _Nonnull)(ZDKClassicUser * _Nullable, NSError * _Nullable))completion;
...
///   </li>
/// </ul>
- (void)setUserFields:(NSDictionary<NSString *, id> * _Nonnull)userFields completion:(void (^ _Nonnull)(ZDKClassicUser * _Nullable, NSError * _Nullable))completion;
...
///   </li>
/// </ul>
- (void)getUserFieldsWithCompletion:(void (^ _Nonnull)(NSArray<ZDKClassicUserField *> * _Nonnull, NSError * _Nullable))completion;
...
@interface ZDKClassicZendesk : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull zendeskUrl;
@property (nonatomic, readonly) enum ZDKClassicIdentityType identityType;
...
@interface ZDKClassicZendesk (SWIFT_EXTENSION(ZendeskCoreSDK))
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) ZDKClassicZendesk * _Nullable instance;)
+ (ZDKClassicZendesk * _Nullable)instance SWIFT_WARN_UNUSED_RESULT;
